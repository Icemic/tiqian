...
object DomParagraphRenderer {
    ...
    internal data class BopomofoCssPlacement(
        val left: Float,
        val top: Float,
        val fontSize: Float,
    ...
    internal val metricsCtx: CanvasRenderingContext2D by lazy {
        val canvas = document.createElement("canvas") as HTMLCanvasElement
        canvas.getContext("2d") as CanvasRenderingContext2D
    }

    internal fun Double.toFloatOrNull(): Float? =
        if (isFinite() && this > 0.0) toFloat() else null

    internal fun resetEngineInline(element: HTMLElement) {
    ...
    internal const val GEOMETRY_SPAN_ATTRIBUTE = "data-tq-geometry"
    internal const val SPACING_CARRIER_ATTRIBUTE = "data-tq-spacing-carrier"
    ...
    internal const val BASELINE_METRIC_PROBE = "中"
    internal const val BOPOMOFO_LANG = "zh-Hant-TW"
    ...
    internal const val LINE_THICKNESS_EM = 0.08f
    internal const val RUBY_ASCENT_RATIO = 0.8f // fallback 注文 ascent when font metrics are unavailable
    internal const val BOPOMOFO_TONE_TARGET_INK_WIDTH_SCALE = 0.82f
    internal const val BOPOMOFO_TONE_SLASH_INK_WIDTH_EM_REGULAR = 0.404f
    internal const val BOPOMOFO_TONE_SLASH_INK_WIDTH_EM_SEMIBOLD = 0.446f
    internal const val BOPOMOFO_TONE_CARON_INK_WIDTH_EM_REGULAR = 0.644f
    internal const val BOPOMOFO_TONE_CARON_INK_WIDTH_EM_SEMIBOLD = 0.682f
    internal const val WAVY_HALF_WAVE_EM = 0.2f
    internal const val WAVY_AMPLITUDE_EM = 0.06f
    internal const val WAVY_ENDPOINT_EPSILON_PX = 0.01f
