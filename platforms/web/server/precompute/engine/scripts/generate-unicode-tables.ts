// Generates the engine unicode_tables.rs from the Unicode
...
//
// node scripts/generate-unicode-tables.ts (from platforms/web/server/precompute/engine)
...
const outPath: string = resolve(here, "../src/unicode_tables.rs");
