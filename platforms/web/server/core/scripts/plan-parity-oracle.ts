...
// `platforms/web/server/precompute/engine/tests/plan_parity.rs`, and writes
// `platforms/web/server/core/build/plan-parity/oracle.json`. The Rust test byte-compares that file
...
// span-carrying case.
//
// Node only: node scripts/plan-parity-oracle.ts (from platforms/web/server/core).
