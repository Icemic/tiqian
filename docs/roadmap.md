...
- `LayeredCacheAndBatchRenderer`：precompute 缓存分层、批量渲染器与二进制过桥协议
  ...
  内建 SQLite 参考实现。
  sveltekit 站点 缓存按附录测量预计从 115.2 MB 降到约 50 MB。实施分三批：协议与批量渲染器、
