...
//         - platforms/web/client/core/src/services/ (the ServiceDirectoryRule home)
//         - platforms/web/client/core/src/engine/layout-worker.ts (worker world:
...
const SCAN_ROOTS: readonly string[] = ["platforms/web/client/core/src", "platforms/web/client/web-component"];
const SANCTIONED_PREFIXES: readonly string[] = [
  "platforms/web/client/core/src/services/",
  "platforms/web/client/core/src/engine/layout-worker.ts",
];
...
const EXEMPTIONS: ReadonlyMap<string, Exemption> = new Map([
  ["platforms/web/client/core/src/sampler/snapshot/snapshot-manifest.ts", {
  ...
  ["platforms/web/client/core/src/sampler/snapshot/precomputed.ts", {
  ...
  ["platforms/web/client/core/src/engine/markdown-lowering.ts", {
