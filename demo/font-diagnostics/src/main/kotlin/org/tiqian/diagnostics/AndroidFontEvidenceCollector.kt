...
object AndroidFontEvidenceCollector {
    ...
    private fun deviceJson(): Map<String, Any?> = linkedMapOf(
    ...
    private fun capabilitiesJson(): List<Map<String, Any?>> = listOf(
    ...
    private fun capability(id: String, minimumApi: Int): Map<String, Any?> = linkedMapOf(
        "id" to id,
    ...
    private fun evidenceStatusCounts(observations: List<Observation>): Map<EvidenceStatus, Int> {
